...
export declare class ProgressService {
    ...
    constructor(progressRepository: Repository<Progress>, nftRepository: Repository<NFTCertificate>, lessonRepository: Repository<Lesson>, quizRepository: Repository<Quiz>, usersService: UsersService, stellarService: StellarService);
